...
public class Tabuleiro {
	...
	private void adicionarCasas() {
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 100, 50,
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 60, 50,
				new TabelaAluguel(4, 20, 60, 180, 320, 450)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 240, 150,
				new TabelaAluguel(20, 100, 300, 750, 925, 1100)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 220, 150,
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 160, 100,
				new TabelaAluguel(12, 60, 180, 500, 700, 900)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 140, 100,
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 260, 150,
				new TabelaAluguel(22, 110, 330, 800, 975, 1150)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 320, 200,
				new TabelaAluguel(28, 150, 450, 1000, 1200, 1400)));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 300, 200,
				new TabelaAluguel(26, 130, 390, 900, 1100, 1275)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 300, 200,
				new TabelaAluguel(26, 130, 390, 900, 1100, 1275)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 280, 150,
