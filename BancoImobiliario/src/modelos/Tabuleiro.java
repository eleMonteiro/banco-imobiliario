...
public class Tabuleiro {
	...
	private void adicionarCasas() {
		...
		terrenoLilas1.setAcao(new AcaoTerreno(terrenoLilas1));
		...
		terrenoLilas2.setAcao(new AcaoTerreno(terrenoLilas2));
		...
		terrenoLilas3.setAcao(new AcaoTerreno(terrenoLilas3));
		this.casas.add(terrenoLilas3);
		
		Companhia companhia1 =  new Companhia(Banco.getInstance(), 200, 50);
		companhia1.setAcao(new AcaoCompanhia());
		...
		terrenoAzulClaro1.setAcao(new AcaoTerreno(terrenoAzulClaro1));
		this.casas.add(terrenoAzulClaro1);
		
		Companhia companhia2 = new Companhia(Banco.getInstance(), 200, 50);
		companhia2.setAcao(new AcaoCompanhia());
		...
		terrenoVioleta1.setAcao(new AcaoTerreno(terrenoVioleta1));
		...
		terrenoLaranja1.setAcao(new AcaoTerreno(terrenoLaranja1));
		this.casas.add(terrenoLaranja1);
		
		CasaEspecialComTaxa casaEspecialComTaxa1 = new CasaEspecialComTaxa(200);
		casaEspecialComTaxa1.setAcao(new AcaoLucrosEDividendos(casaEspecialComTaxa1));
		...
		terrenoLaranja2.setAcao(new AcaoTerreno(terrenoLaranja2));
		this.casas.add(terrenoLaranja2);
		
		CasaEspecial casaEspecial1 = new CasaEspecial();
		casaEspecial1.setAcao(new AcaoParadaLivre());
		...
		terrenoVermelho1.setAcao(new AcaoTerreno(terrenoVermelho1));
		...
		terrenoAmarelo1.setAcao(new AcaoTerreno(terrenoAmarelo1));
		...
		terrenoAmarelo2.setAcao(new AcaoTerreno(terrenoAmarelo2));
		...
		terrenoAmarelo3.setAcao(new AcaoTerreno(terrenoAmarelo3));
		...
		terrenoVerde1.setAcao(new AcaoTerreno(terrenoVerde1));
		this.casas.add(terrenoVerde1);
		
		Companhia companhia5 = new Companhia(Banco.getInstance(), 200, 50);
		companhia5.setAcao(new AcaoCompanhia());
		...
		terrenoVerde2.setAcao(new AcaoTerreno(terrenoVerde2));
		...
		terrenoAzulEs1.setAcao(new AcaoTerreno(terrenoAzulEs1));
