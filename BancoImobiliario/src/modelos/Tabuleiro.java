...
public class Tabuleiro {
	...
	private void adicionarCasas() {
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoTerreno(), 240, 150, "Azul Claro",
				new TabelaAluguel(20, 100, 300, 750, 925, 1100)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoCompanhia(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoTerreno(), 220, 150, "Azul Claro",
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoTerreno(), 400, 200, "Laranja",
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoTerreno(), 260, 150, "Verde",
				new TabelaAluguel(22, 110, 330, 800, 975, 1150)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoCompanhia(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoTerreno(), 320, 200, "Verde",
