...
public class Tabuleiro {
	...
	private void adicionarCasas() {
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 100, 50, "Lilas",
				new TabelaAluguel(6, 30, 90, 270, 400, 500)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(
				new Terreno(Banco.getInstance(), new AcaoImovel(), 60, 50, "Lilas", new TabelaAluguel(2, 10, 30, 90, 160, 250)));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 60, 50, "Lilas",
				new TabelaAluguel(4, 20, 60, 180, 320, 450)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 240, 150, "Azul Claro",
				new TabelaAluguel(20, 100, 300, 750, 925, 1100)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 220, 150, "Azul Claro",
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 200, 100, "Violeta",
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 400, 200, "Laranja",
				new TabelaAluguel(50, 200, 600, 1400, 1700, 2000)));
		this.casas.add(new CasaEspecial(new AcaoParadaLivre()));

		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 120, 50, "Vermelho",
				new TabelaAluguel(8, 40, 100, 300, 450, 600)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 100, 50, "Vermelho",
				new TabelaAluguel(6, 30, 90, 270, 400, 500)));
		this.casas.add(new CasaEspecialComTaxa(new AcaoImpostoDeRenda(), 200));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 40));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 160, 100, "Amarelo",
				new TabelaAluguel(12, 60, 180, 500, 700, 900)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 140, 100, "Amarelo",
		...
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 260, 150, "Verde",
				new TabelaAluguel(22, 110, 330, 800, 975, 1150)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 320, 200, "Verde",
				new TabelaAluguel(28, 150, 450, 1000, 1200, 1400)));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 300, 200, "Verde",
				new TabelaAluguel(26, 130, 390, 900, 1100, 1275)));
		this.casas.add(new Companhia(Banco.getInstance(), new AcaoImovel(), 200, 50));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 300, 200, "Verde",
				new TabelaAluguel(26, 130, 390, 900, 1100, 1275)));
		this.casas.add(new CasaEspecial(new AcaoSorteOuReves()));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 280, 150, "Azul Escuro",
				new TabelaAluguel(24, 120, 360, 850, 1025, 1200)));
		this.casas.add(new Terreno(Banco.getInstance(), new AcaoImovel(), 260, 150, "Azul Escuro",
				new TabelaAluguel(22, 110, 330, 800, 975, 1150)));
	}
