...
import acoes.AcaoPagarValorCartaReves;
import acoes.AcaoReceberValorCartaSorte;
...
public class RepositorioCartasSorteOuReves {
	...
	private void adicionarCartasSorteOuReves() {
		...
		carta01.setAcao(new AcaoReceberValorCartaSorte(25));
		...
		carta10.setAcao(new AcaoReceberValorCartaSorte(50));

		CartaSorteOuReves carta11 = new CartaSorteOuReves("Sorte",
				"Um amigo tinha lhe pedido um emprestimo e se esqqueceu de devolver. Ele acaba de se lembrar.");
		carta11.setAcao(new AcaoReceberValorCartaSorte(50));
		...
		carta18.setAcao(new AcaoReceberValorCartaSorte(50));
		...
		carta30.setAcao(new AcaoReceberValorCartaSorte(100));
